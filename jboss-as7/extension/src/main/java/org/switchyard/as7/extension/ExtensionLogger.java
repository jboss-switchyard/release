...
public interface ExtensionLogger {
    ...
    @Message(id = 38000, value = "Unable to destroy web context")
    ...
    @Message(id = 38001, value = "Unable to determine host address from connector.  Using alias definition instead.")
     ...
     */
    @LogMessage(level = ERROR)
    @Message(id = 38002, value = "Unable to instantiate class %s")
     ...
     */
    @LogMessage(level = ERROR)
    @Message(id = 38003, value = "Unable to access constructor for %s")
     ...
     */
    @LogMessage(level = ERROR)
    @Message(id = 38004, value = "Unable to load class %s")
     ...
     */
    @LogMessage(level = ERROR)
    @Message(id = 38005, value = "Unable to load module %s")
     ...
     */
    @LogMessage(level = ERROR)
    @Message(id = 38006, value = "Unable to stop %s")
