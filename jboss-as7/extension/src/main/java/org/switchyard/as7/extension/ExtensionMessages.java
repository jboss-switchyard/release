...
/**
 * <p/>
 * This file is using the subset 30400-10799 for logger messages.
 * <p/>
 *
 */
...
public interface ExtensionMessages {
     ...
     */
    @Message(id = 30400, value = "%s already declared %s")
     ...
     * @return String
     */
    @Message(id = 30401, value = "Error starting gateway: ")
     ...
     * @return String
     */
    @Message(id = 30402, value = "Unknown gateway.")
     ...
     */
    @Message(id = 30403, value = "Unable to create temp directory %s")
     ...
     * @return RuntimeException
     */
    @Message(id = 30404, value = "Context %s already exists!")
     ...
     */
    @Message(id = 30405, value = "Could not instantiate interceptor class: %s")
