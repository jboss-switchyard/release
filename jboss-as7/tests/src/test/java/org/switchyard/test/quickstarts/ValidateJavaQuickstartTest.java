...
public class ValidateJavaQuickstartTest {

    @Deployment(testable = false)
    public static JavaArchive createDeployment() {
        return ArquillianUtil.createJarQSDeployment("switchyard-quickstart-validate-java");
    }
    ...
    public void testOrders() throws Exception {
        ...
        try {
            String response = httpMixIn.postString("http://localhost:8080/validate-java/OrderService", SOAP_REQUEST);
    ...
    private static final String SOAP_REQUEST = "<soap:Envelope xmlns:soap=\"http://www.w3.org/2003/05/soap-envelope\">\n" +
            "    <soap:Body>\n" +
            "        <orders:submitOrder xmlns:orders=\"urn:switchyard-quickstart:validate-java:1.0\">\n" +
            "            <order>\n" +
